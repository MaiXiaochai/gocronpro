# 注意：
 - **目前该库仅仅是作为源代码的备份，根据实际生产的改进版目前只离线托管，时机成熟时候会放出。**
 - [**2024-06-24**] 为什么要fork自己的版本？
   - 原版程序我司已在多节点环境下使用多年，比较稳定。所以，想进一步整合一些功能进去，同时对一些细节进行改进，修复一些BUG。
   - 但原版本似乎已经多年不更新，issue中似乎是维护者贴出[不再维护的帖子](https://github.com/ouqiang/gocron/issues/387)。所以，决定自己来。
   - 同时，也为了学习一下Golang，需求驱动，学习更快。
   - 能力有限，首先以实用为主，然后再追求优雅。代码不足之处还请轻拍板砖，如果您能指出不足，并给出改进意见，感激不尽。
   - 取之于开源，回馈于开源。
